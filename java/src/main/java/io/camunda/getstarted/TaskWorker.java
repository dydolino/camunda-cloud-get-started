...
public class TaskWorker {
        ...
        private static final Logger LOG = LogManager.getLogger(io.camunda.getstarted.TaskWorker.class);

        public static void main(String[] args) {
            try (ZeebeClient client = ZeebeClientFactory.getZeebeClient()) {
                client.newWorker().jobType("task").handler((jobClient, job) -> {
                    final String message_content = (String) job.getVariablesAsMap().get("id");
